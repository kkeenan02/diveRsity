% \VignetteIndexEntry{diveRsity Help}
...
The package is updated regularly, both with added functionality and bug fixes. The most up to date notes and versions of the package can be found at: \\
\href{http://diversityinlife.weebly.com/software.html}{\textcolor{blue}{http://diversityinlife.weebly.com/software.html}}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
<<echo=FALSE, quiet=TRUE, results='hide'>>=
