...
divfl <- system.file("doc", "vigData", "div_res.RData", package = "diveRsity")
load(divfl)
res <- div_results
@
...
<<echo=FALSE, results=hide>>=
infl <- system.file("doc", "vigData", "in_res.RData", package = "diveRsity")
load(infl)
res_in <- in_results
@
...
Many thanks to all of our colleagues for testing code and reporting bugs. In particular, we thank Mark Ravinet, Erin Landguth, Mariah Meek and Andy Jasonowicz for reporting important bugs and for making useful suggestions for the improvement of the package.
